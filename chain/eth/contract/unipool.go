...
func bindUnipool(address common.Address, caller bind.ContractCaller, transactor bind.ContractTransactor, filterer bind.ContractFilterer) (*bind.BoundContract, error) {
	parsed, err := abi.JSON(strings.NewReader(UnipoolABI))
	if err != nil {
		return nil, err
	}
...
func (_Unipool *UnipoolCaller) Fee(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _Unipool.contract.Call(opts, &out, "fee")
...
func (_Unipool *UnipoolSession) Fee() (*big.Int, error) {
	return _Unipool.Contract.Fee(&_Unipool.CallOpts)
}
...
func (_Unipool *UnipoolCaller) FeeGrowthGlobal0X128(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _Unipool.contract.Call(opts, &out, "feeGrowthGlobal0X128")
...
func (_Unipool *UnipoolSession) FeeGrowthGlobal0X128() (*big.Int, error) {
	return _Unipool.Contract.FeeGrowthGlobal0X128(&_Unipool.CallOpts)
}
...
func (_Unipool *UnipoolCaller) FeeGrowthGlobal1X128(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _Unipool.contract.Call(opts, &out, "feeGrowthGlobal1X128")
...
func (_Unipool *UnipoolSession) FeeGrowthGlobal1X128() (*big.Int, error) {
	return _Unipool.Contract.FeeGrowthGlobal1X128(&_Unipool.CallOpts)
}
...
func (_Unipool *UnipoolCaller) Liquidity(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _Unipool.contract.Call(opts, &out, "liquidity")
...
func (_Unipool *UnipoolSession) Liquidity() (*big.Int, error) {
	return _Unipool.Contract.Liquidity(&_Unipool.CallOpts)
}
...
func (_Unipool *UnipoolCaller) MaxLiquidityPerTick(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _Unipool.contract.Call(opts, &out, "maxLiquidityPerTick")
...
func (_Unipool *UnipoolSession) MaxLiquidityPerTick() (*big.Int, error) {
	return _Unipool.Contract.MaxLiquidityPerTick(&_Unipool.CallOpts)
}
...
func (_Unipool *UnipoolCaller) Observations(opts *bind.CallOpts, arg0 *big.Int) (struct {
	...
	var out []interface{}
	err := _Unipool.contract.Call(opts, &out, "observations", arg0)
...
func (_Unipool *UnipoolSession) Observations(arg0 *big.Int) (struct {
	...
	return _Unipool.Contract.Observations(&_Unipool.CallOpts, arg0)
}
...
func (_Unipool *UnipoolCaller) Observe(opts *bind.CallOpts, secondsAgos []uint32) (struct {
	...
	var out []interface{}
	err := _Unipool.contract.Call(opts, &out, "observe", secondsAgos)
...
func (_Unipool *UnipoolSession) Observe(secondsAgos []uint32) (struct {
	...
	return _Unipool.Contract.Observe(&_Unipool.CallOpts, secondsAgos)
}
...
func (_Unipool *UnipoolCaller) Positions(opts *bind.CallOpts, arg0 [32]byte) (struct {
	...
	var out []interface{}
	err := _Unipool.contract.Call(opts, &out, "positions", arg0)
...
func (_Unipool *UnipoolSession) Positions(arg0 [32]byte) (struct {
	...
	return _Unipool.Contract.Positions(&_Unipool.CallOpts, arg0)
}
...
func (_Unipool *UnipoolCaller) ProtocolFees(opts *bind.CallOpts) (struct {
	...
	var out []interface{}
	err := _Unipool.contract.Call(opts, &out, "protocolFees")
...
func (_Unipool *UnipoolSession) ProtocolFees() (struct {
	...
	return _Unipool.Contract.ProtocolFees(&_Unipool.CallOpts)
}
...
func (_Unipool *UnipoolCaller) SnapshotCumulativesInside(opts *bind.CallOpts, tickLower *big.Int, tickUpper *big.Int) (struct {
	...
	var out []interface{}
	err := _Unipool.contract.Call(opts, &out, "snapshotCumulativesInside", tickLower, tickUpper)
...
func (_Unipool *UnipoolSession) SnapshotCumulativesInside(tickLower *big.Int, tickUpper *big.Int) (struct {
	...
	return _Unipool.Contract.SnapshotCumulativesInside(&_Unipool.CallOpts, tickLower, tickUpper)
}
...
func (_Unipool *UnipoolCaller) TickBitmap(opts *bind.CallOpts, arg0 int16) (*big.Int, error) {
	var out []interface{}
	err := _Unipool.contract.Call(opts, &out, "tickBitmap", arg0)
...
func (_Unipool *UnipoolSession) TickBitmap(arg0 int16) (*big.Int, error) {
	return _Unipool.Contract.TickBitmap(&_Unipool.CallOpts, arg0)
}
...
func (_Unipool *UnipoolCaller) Ticks(opts *bind.CallOpts, arg0 *big.Int) (struct {
	...
	var out []interface{}
	err := _Unipool.contract.Call(opts, &out, "ticks", arg0)
...
func (_Unipool *UnipoolSession) Ticks(arg0 *big.Int) (struct {
	...
	return _Unipool.Contract.Ticks(&_Unipool.CallOpts, arg0)
}
...
func (_Unipool *UnipoolTransactor) Burn(opts *bind.TransactOpts, tickLower *big.Int, tickUpper *big.Int, amount *big.Int) (*types.Transaction, error) {
	return _Unipool.contract.Transact(opts, "burn", tickLower, tickUpper, amount)
}
...
func (_Unipool *UnipoolSession) Burn(tickLower *big.Int, tickUpper *big.Int, amount *big.Int) (*types.Transaction, error) {
	return _Unipool.Contract.Burn(&_Unipool.TransactOpts, tickLower, tickUpper, amount)
}
...
func (_Unipool *UnipoolTransactor) Collect(opts *bind.TransactOpts, recipient common.Address, tickLower *big.Int, tickUpper *big.Int, amount0Requested *big.Int, amount1Requested *big.Int) (*types.Transaction, error) {
	return _Unipool.contract.Transact(opts, "collect", recipient, tickLower, tickUpper, amount0Requested, amount1Requested)
}
...
func (_Unipool *UnipoolSession) Collect(recipient common.Address, tickLower *big.Int, tickUpper *big.Int, amount0Requested *big.Int, amount1Requested *big.Int) (*types.Transaction, error) {
	return _Unipool.Contract.Collect(&_Unipool.TransactOpts, recipient, tickLower, tickUpper, amount0Requested, amount1Requested)
}
...
func (_Unipool *UnipoolTransactor) CollectProtocol(opts *bind.TransactOpts, recipient common.Address, amount0Requested *big.Int, amount1Requested *big.Int) (*types.Transaction, error) {
	return _Unipool.contract.Transact(opts, "collectProtocol", recipient, amount0Requested, amount1Requested)
}
...
func (_Unipool *UnipoolSession) CollectProtocol(recipient common.Address, amount0Requested *big.Int, amount1Requested *big.Int) (*types.Transaction, error) {
	return _Unipool.Contract.CollectProtocol(&_Unipool.TransactOpts, recipient, amount0Requested, amount1Requested)
}
...
func (_Unipool *UnipoolTransactor) Flash(opts *bind.TransactOpts, recipient common.Address, amount0 *big.Int, amount1 *big.Int, data []byte) (*types.Transaction, error) {
	return _Unipool.contract.Transact(opts, "flash", recipient, amount0, amount1, data)
}
...
func (_Unipool *UnipoolSession) Flash(recipient common.Address, amount0 *big.Int, amount1 *big.Int, data []byte) (*types.Transaction, error) {
	return _Unipool.Contract.Flash(&_Unipool.TransactOpts, recipient, amount0, amount1, data)
}
...
func (_Unipool *UnipoolTransactor) IncreaseObservationCardinalityNext(opts *bind.TransactOpts, observationCardinalityNext uint16) (*types.Transaction, error) {
	return _Unipool.contract.Transact(opts, "increaseObservationCardinalityNext", observationCardinalityNext)
}
...
func (_Unipool *UnipoolSession) IncreaseObservationCardinalityNext(observationCardinalityNext uint16) (*types.Transaction, error) {
	return _Unipool.Contract.IncreaseObservationCardinalityNext(&_Unipool.TransactOpts, observationCardinalityNext)
}
...
func (_Unipool *UnipoolTransactor) Initialize(opts *bind.TransactOpts, sqrtPriceX96 *big.Int) (*types.Transaction, error) {
	return _Unipool.contract.Transact(opts, "initialize", sqrtPriceX96)
}
...
func (_Unipool *UnipoolSession) Initialize(sqrtPriceX96 *big.Int) (*types.Transaction, error) {
	return _Unipool.Contract.Initialize(&_Unipool.TransactOpts, sqrtPriceX96)
}
...
func (_Unipool *UnipoolTransactor) Mint(opts *bind.TransactOpts, recipient common.Address, tickLower *big.Int, tickUpper *big.Int, amount *big.Int, data []byte) (*types.Transaction, error) {
	return _Unipool.contract.Transact(opts, "mint", recipient, tickLower, tickUpper, amount, data)
}
...
func (_Unipool *UnipoolSession) Mint(recipient common.Address, tickLower *big.Int, tickUpper *big.Int, amount *big.Int, data []byte) (*types.Transaction, error) {
	return _Unipool.Contract.Mint(&_Unipool.TransactOpts, recipient, tickLower, tickUpper, amount, data)
}
...
func (_Unipool *UnipoolTransactor) SetFeeProtocol(opts *bind.TransactOpts, feeProtocol0 uint8, feeProtocol1 uint8) (*types.Transaction, error) {
	return _Unipool.contract.Transact(opts, "setFeeProtocol", feeProtocol0, feeProtocol1)
}
...
func (_Unipool *UnipoolSession) SetFeeProtocol(feeProtocol0 uint8, feeProtocol1 uint8) (*types.Transaction, error) {
	return _Unipool.Contract.SetFeeProtocol(&_Unipool.TransactOpts, feeProtocol0, feeProtocol1)
}
...
func (_Unipool *UnipoolTransactor) Swap(opts *bind.TransactOpts, recipient common.Address, zeroForOne bool, amountSpecified *big.Int, sqrtPriceLimitX96 *big.Int, data []byte) (*types.Transaction, error) {
	return _Unipool.contract.Transact(opts, "swap", recipient, zeroForOne, amountSpecified, sqrtPriceLimitX96, data)
}
...
func (_Unipool *UnipoolSession) Swap(recipient common.Address, zeroForOne bool, amountSpecified *big.Int, sqrtPriceLimitX96 *big.Int, data []byte) (*types.Transaction, error) {
	return _Unipool.Contract.Swap(&_Unipool.TransactOpts, recipient, zeroForOne, amountSpecified, sqrtPriceLimitX96, data)
}
...
func (_Unipool *UnipoolFilterer) FilterBurn(opts *bind.FilterOpts, owner []common.Address, tickLower []*big.Int, tickUpper []*big.Int) (*UnipoolBurnIterator, error) {
	...
	logs, sub, err := _Unipool.contract.FilterLogs(opts, "Burn", ownerRule, tickLowerRule, tickUpperRule)
	if err != nil {
		return nil, err
	}
...
func (_Unipool *UnipoolFilterer) WatchBurn(opts *bind.WatchOpts, sink chan<- *UnipoolBurn, owner []common.Address, tickLower []*big.Int, tickUpper []*big.Int) (event.Subscription, error) {
	...
	logs, sub, err := _Unipool.contract.WatchLogs(opts, "Burn", ownerRule, tickLowerRule, tickUpperRule)
	if err != nil {
		return nil, err
	}
...
func (_Unipool *UnipoolFilterer) FilterCollect(opts *bind.FilterOpts, owner []common.Address, tickLower []*big.Int, tickUpper []*big.Int) (*UnipoolCollectIterator, error) {
	...
	logs, sub, err := _Unipool.contract.FilterLogs(opts, "Collect", ownerRule, tickLowerRule, tickUpperRule)
	if err != nil {
		return nil, err
	}
	return &UnipoolCollectIterator{contract: _Unipool.contract, event: "Collect", logs: logs, sub: sub}, nil
}
...
func (_Unipool *UnipoolFilterer) WatchCollect(opts *bind.WatchOpts, sink chan<- *UnipoolCollect, owner []common.Address, tickLower []*big.Int, tickUpper []*big.Int) (event.Subscription, error) {
	...
	logs, sub, err := _Unipool.contract.WatchLogs(opts, "Collect", ownerRule, tickLowerRule, tickUpperRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(UnipoolCollect)
				if err := _Unipool.contract.UnpackLog(event, "Collect", log); err != nil {
					return err
				}
				event.Raw = log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *UnipoolCollectProtocolIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(UnipoolCollectProtocol)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *UnipoolCollectProtocolIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *UnipoolCollectProtocolIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}
...
func (_Unipool *UnipoolFilterer) FilterCollectProtocol(opts *bind.FilterOpts, sender []common.Address, recipient []common.Address) (*UnipoolCollectProtocolIterator, error) {
	...
	logs, sub, err := _Unipool.contract.FilterLogs(opts, "CollectProtocol", senderRule, recipientRule)
	if err != nil {
		return nil, err
	}
	return &UnipoolCollectProtocolIterator{contract: _Unipool.contract, event: "CollectProtocol", logs: logs, sub: sub}, nil
}
...
func (_Unipool *UnipoolFilterer) WatchCollectProtocol(opts *bind.WatchOpts, sink chan<- *UnipoolCollectProtocol, sender []common.Address, recipient []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _Unipool.contract.WatchLogs(opts, "CollectProtocol", senderRule, recipientRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(UnipoolCollectProtocol)
				if err := _Unipool.contract.UnpackLog(event, "CollectProtocol", log); err != nil {
					return err
				}
				event.Raw = log
...
func (_Unipool *UnipoolFilterer) FilterFlash(opts *bind.FilterOpts, sender []common.Address, recipient []common.Address) (*UnipoolFlashIterator, error) {
	...
	logs, sub, err := _Unipool.contract.FilterLogs(opts, "Flash", senderRule, recipientRule)
	if err != nil {
		return nil, err
	}
	return &UnipoolFlashIterator{contract: _Unipool.contract, event: "Flash", logs: logs, sub: sub}, nil
}
...
func (_Unipool *UnipoolFilterer) WatchFlash(opts *bind.WatchOpts, sink chan<- *UnipoolFlash, sender []common.Address, recipient []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _Unipool.contract.WatchLogs(opts, "Flash", senderRule, recipientRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(UnipoolFlash)
				if err := _Unipool.contract.UnpackLog(event, "Flash", log); err != nil {
					return err
				}
				event.Raw = log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *UnipoolIncreaseObservationCardinalityNextIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(UnipoolIncreaseObservationCardinalityNext)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *UnipoolIncreaseObservationCardinalityNextIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *UnipoolIncreaseObservationCardinalityNextIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}
...
func (_Unipool *UnipoolFilterer) FilterIncreaseObservationCardinalityNext(opts *bind.FilterOpts) (*UnipoolIncreaseObservationCardinalityNextIterator, error) {
	...
	logs, sub, err := _Unipool.contract.FilterLogs(opts, "IncreaseObservationCardinalityNext")
	if err != nil {
		return nil, err
	}
	return &UnipoolIncreaseObservationCardinalityNextIterator{contract: _Unipool.contract, event: "IncreaseObservationCardinalityNext", logs: logs, sub: sub}, nil
}
...
func (_Unipool *UnipoolFilterer) WatchIncreaseObservationCardinalityNext(opts *bind.WatchOpts, sink chan<- *UnipoolIncreaseObservationCardinalityNext) (event.Subscription, error) {
	...
	logs, sub, err := _Unipool.contract.WatchLogs(opts, "IncreaseObservationCardinalityNext")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(UnipoolIncreaseObservationCardinalityNext)
				if err := _Unipool.contract.UnpackLog(event, "IncreaseObservationCardinalityNext", log); err != nil {
					return err
				}
				event.Raw = log
...
func (it *UnipoolInitializeIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(UnipoolInitialize)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
func (_Unipool *UnipoolFilterer) FilterInitialize(opts *bind.FilterOpts) (*UnipoolInitializeIterator, error) {
	...
	logs, sub, err := _Unipool.contract.FilterLogs(opts, "Initialize")
	if err != nil {
		return nil, err
	}
	return &UnipoolInitializeIterator{contract: _Unipool.contract, event: "Initialize", logs: logs, sub: sub}, nil
}
...
func (_Unipool *UnipoolFilterer) WatchInitialize(opts *bind.WatchOpts, sink chan<- *UnipoolInitialize) (event.Subscription, error) {
	...
	logs, sub, err := _Unipool.contract.WatchLogs(opts, "Initialize")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(UnipoolInitialize)
				if err := _Unipool.contract.UnpackLog(event, "Initialize", log); err != nil {
					return err
				}
				event.Raw = log
...
func (_Unipool *UnipoolFilterer) FilterMint(opts *bind.FilterOpts, owner []common.Address, tickLower []*big.Int, tickUpper []*big.Int) (*UnipoolMintIterator, error) {
	...
	logs, sub, err := _Unipool.contract.FilterLogs(opts, "Mint", ownerRule, tickLowerRule, tickUpperRule)
	if err != nil {
		return nil, err
	}
...
func (_Unipool *UnipoolFilterer) WatchMint(opts *bind.WatchOpts, sink chan<- *UnipoolMint, owner []common.Address, tickLower []*big.Int, tickUpper []*big.Int) (event.Subscription, error) {
	...
	logs, sub, err := _Unipool.contract.WatchLogs(opts, "Mint", ownerRule, tickLowerRule, tickUpperRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *UnipoolSetFeeProtocolIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(UnipoolSetFeeProtocol)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *UnipoolSetFeeProtocolIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *UnipoolSetFeeProtocolIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}
...
func (_Unipool *UnipoolFilterer) FilterSetFeeProtocol(opts *bind.FilterOpts) (*UnipoolSetFeeProtocolIterator, error) {
	...
	logs, sub, err := _Unipool.contract.FilterLogs(opts, "SetFeeProtocol")
	if err != nil {
		return nil, err
	}
	return &UnipoolSetFeeProtocolIterator{contract: _Unipool.contract, event: "SetFeeProtocol", logs: logs, sub: sub}, nil
}
...
func (_Unipool *UnipoolFilterer) WatchSetFeeProtocol(opts *bind.WatchOpts, sink chan<- *UnipoolSetFeeProtocol) (event.Subscription, error) {
	...
	logs, sub, err := _Unipool.contract.WatchLogs(opts, "SetFeeProtocol")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(UnipoolSetFeeProtocol)
				if err := _Unipool.contract.UnpackLog(event, "SetFeeProtocol", log); err != nil {
					return err
				}
				event.Raw = log
...
func (_Unipool *UnipoolFilterer) FilterSwap(opts *bind.FilterOpts, sender []common.Address, recipient []common.Address) (*UnipoolSwapIterator, error) {
	...
	logs, sub, err := _Unipool.contract.FilterLogs(opts, "Swap", senderRule, recipientRule)
	if err != nil {
		return nil, err
	}
...
func (_Unipool *UnipoolFilterer) WatchSwap(opts *bind.WatchOpts, sink chan<- *UnipoolSwap, sender []common.Address, recipient []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _Unipool.contract.WatchLogs(opts, "Swap", senderRule, recipientRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
